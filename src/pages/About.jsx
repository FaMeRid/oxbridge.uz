...
const ACADEMY_INFO = {
  ...
  address: "123 Academy Street, Termez 190100, Uzbekistan",
};
...
const SOCIAL_LINKS = {
  ...
  facebook: "https://facebook.com/oxbridgeuz",
  whatsapp: "+998 99 999 99 99",
};
...
const FACULTY_MEMBERS = [
  {
    ...
    achievements: [
      ...
      "Cambridge Assessment Expert",
    ],
    social: {
      linkedin: "https://linkedin.com",
      email: "s.mitchell@oxbridgeuz.com",
    },
  },
  {
    id: 2,
    ...
    achievements: [
      "Average student improvement: 1.5 bands",
      "British Council Trainer 2019-2022",
    ],
    social: {
      linkedin: "https://linkedin.com",
      email: "j.anderson@oxbridgeuz.com",
    },
  },
  {
    id: 3,
    ...
    achievements: [
      "Developed 3 IELTS preparation programs",
      "Ministry of Education Consultant",
    ],
    social: {
      linkedin: "https://linkedin.com",
      email: "f.karimova@oxbridgeuz.com",
    },
  },
  {
    id: 4,
    ...
    achievements: [
      ...
      "Created pronunciation app used by 2000+ students",
    ],
    social: {
      linkedin: "https://linkedin.com",
      email: "m.chen@oxbridgeuz.com",
    },
  },
  {
    id: 5,
    ...
    achievements: [
      "Published author",
      "90% of students achieve Band 6.5+ in Writing",
    ],
    social: {
      linkedin: "https://linkedin.com",
      email: "e.petrova@oxbridgeuz.com",
    },
  },
  {
    id: 6,
    ...
    achievements: [
      "Created 50+ practice tests",
      "Average reading score improvement: 2 bands",
    ],
    social: {
      linkedin: "https://linkedin.com",
      email: "d.thompson@oxbridgeuz.com",
    },
  },
];
...
const TESTIMONIALS = [
  {
    name: "Alisher K.",
    university: "Cambridge University '24",
    band: "8.0",
    text: "Thanks to Oxbridge, I achieved Band 8.0 and got into my dream university! The teachers were incredibly supportive.",
    image:
      "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop",
  },
  {
    name: "Sophia M.",
    university: "University of Edinburgh '24",
    band: "8.5",
    text: "The platform combined with classroom teaching transformed my approach to IELTS. Best decision ever!",
    image:
  ...
  },
  {
    ...
    university: "LSE '23",
    band: "7.5",
    text: "Every detail matters at Oxbridge. The mock tests felt exactly like the real exam. Highly recommended!",
    image:
...
const SUCCESS_STORIES = [
  {
    id: 1,
    title: "From 5.5 to 8.0: Zarina's 2.5 Band Jump",
    category: "Student Success",
    excerpt:
      "Zarina struggled with IELTS for years. After 8 weeks at Oxbridge, she achieved Band 8.0 through personalized coaching.",
    image:
  ...
  {
    id: 2,
    title: "Teacher Feature: Dr. Karimova's Innovative Curriculum",
    category: "Featured",
    excerpt:
      "How our Academic Director developed a curriculum that improved Band 7+ achievement rates by 40%.",
    image:
      "https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&h=300&fit=crop",
    date: "Feb 2024",
  },
  {
    id: 3,
    title: "100 Students, 90% Band 7+ Rate: Our 2023 Achievement",
    category: "News",
    excerpt:
      "Oxbridge celebrates record-breaking year with highest student satisfaction and achievement rates in academy history.",
    image:
      "https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&h=300&fit=crop",
    date: "Jan 2024",
  },
...
// ============================================
const AWARDS = [
  { icon: "🏆", title: "Best IELTS Academy", org: "Uzbekistan Education Excellence 2023" },
  { icon: "⭐", title: "5-Star Student Rating", org: "TrustPilot 2023 & 2024" },
  { icon: "🎓", title: "Cambridge Partner Institute", org: "Official Cambridge English Partner" },
  { icon: "📊", title: "90% Success Rate", org: "Students Achieve Target Band" },
];
    ...
    <article className={`ab-event-card${event.featured ? " featured" : ""}`}>
      ...
      <div className="ab-event-body">
        <div className="ab-event-head">
          <ABadge
            type={event.type === "Exam Simulation" ? "accent" : "secondary"}
          >
            {event.type}
          </ABadge>
        ...
        <div className="ab-event-actions">
          <ABtn
            ...
            size="sm"
            onClick={() =>
              !isFull && alert(`Registering for: ${event.title}`)
            }
          >
...
const EventsTab = () => {
  ...
  const filtered = useMemo(() => {
    ...
    if (filter === "featured")
      return ACADEMY_EVENTS.filter((e) => e.featured);
    return ACADEMY_EVENTS.filter((e) =>
      ...
      <div className="ab-testimonials-grid">
        {TESTIMONIALS.map((testimonial, idx) => (
          <div key={idx} className="ab-testimonial-card">
            ...
            <p className="ab-testimonial-text">"{testimonial.text}"</p>
            <div className="ab-testimonial-author">
              ...
              />
              <div>
                <p className="ab-testimonial-name">{testimonial.name}</p>
                <p className="ab-testimonial-details">
                  Band {testimonial.band} • {testimonial.university}
                </p>
              </div>
            </div>
          </div>
